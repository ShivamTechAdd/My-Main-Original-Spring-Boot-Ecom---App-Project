package com.ecomerce.sbecom.security;
...
import com.ecomerce.sbecom.security.jwt.AuthEntryPointJwt;
import com.ecomerce.sbecom.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/h2-console/**").permitAll()     // H2 console allowed
